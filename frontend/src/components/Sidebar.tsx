...
export const Sidebar: React.FC<SidebarProps> = ({
 ...
 <a
 href="/"
 className="relative group flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-b from-white/[0.08] to-transparent border border-white/[0.08] hover:border-indigo-500/40 transition-all shadow-inner"
 title="NEURO-CUT // Agentic Showrunner Studio"
 >
 <span className="font-mono font-black text-xs tracking-tighter text-indigo-400 group-hover:text-indigo-300 transition-colors">
 NC
 </span>

...
export const LinearHero: React.FC = () => {
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-gradient-to-b from-amber-500/10 via-purple-500/5 to-transparent blur-[120px] pointer-events-none rounded-full" />
      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col items-center text-center relative z-10">
        {/* Announcement Pill (Linear Style) */}
        <Link
          href="/studio"
          className="group inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.08] hover:border-white/[0.15] text-xs font-berkeley text-zinc-300 transition-all duration-200 mb-8 shadow-inner"
        >
          <span className="w-1.5 h-1.5 rounded-full bg-amber-400 animate-pulse" />
          <span>NEURO-CUT 2.0 // AUTONOMOUS AGENTIC CINEMA</span>
          ...
          <span className="text-amber-400 font-semibold group-hover:translate-x-0.5 transition-transform flex items-center gap-0.5">
            Explore Studio <ArrowRight className="w-3 h-3 inline" />
          </span>
        </Link>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center gap-3.5 w-full justify-center">
          ...
          <a
            href="#benchmark"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-inter font-medium text-sm bg-white/[0.04] hover:bg-white/[0.08] text-zinc-300 hover:text-white border border-white/[0.08] hover:border-white/[0.16] transition-all duration-150 active:scale-[0.98]"
          >
            ...
            <div className="md:col-span-7 bg-[#060608] rounded-xl border border-white/[0.06] p-3 flex flex-col justify-between aspect-video relative overflow-hidden">
              <div className="flex items-center justify-between text-[11px] font-berkeley text-zinc-400">
                <span className="flex items-center gap-1.5 text-zinc-200">
                  <Play className="w-3 h-3 text-amber-400 fill-current" /> Rough Cut Assembly #4
                </span>
              ...
              <div className="pt-2 border-t border-white/[0.06] flex items-center gap-1 font-berkeley text-[9px]">
                ...
                <div className="w-16 h-6 rounded bg-amber-500/20 text-amber-300 border border-amber-500/40 flex items-center justify-center px-1 truncate">
                  Veo B-Roll
                </div>
            ...
            <div className="md:col-span-5 bg-[#060608] rounded-xl border border-white/[0.06] p-3 flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between text-[11px] font-berkeley mb-3">
                  ...
                  <span className="text-amber-400 font-bold">+12.4% Flow</span>
                </div>
                ...
                <div className="space-y-1.5 font-berkeley text-[10px]">
                  ...
                  <div className="flex items-center justify-between p-1.5 rounded bg-amber-500/15 border border-amber-500/30 text-amber-300">

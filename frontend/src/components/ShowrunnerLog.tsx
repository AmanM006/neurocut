...
export const ShowrunnerLog: React.FC<ShowrunnerLogProps> = ({ logs }) => {
 ...
 <div
 key={log.id}
 className="bg-[#14100c] border border-indigo-500/30 rounded-xl p-3 shadow-md transition-all"
 >
 <div className="flex items-center justify-between mb-1.5">
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-indigo-500/15 text-indigo-300 font-bold text-[9px] border border-indigo-500/40 uppercase tracking-wider">
 <Sparkles className="w-2.5 h-2.5 text-indigo-400" /> SHOWRUNNER B-ROLL INJECTION
 </span>
 ...
 {log.details && (
 <p className="mt-1.5 text-[11px] text-indigo-200/80 leading-relaxed bg-black/40 p-2 rounded-lg border border-indigo-500/15">
 {log.details}
 </p>
 )}

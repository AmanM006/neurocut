    ...
    <section id="benchmark" className="py-20 md:py-28 border-t border-white/[0.06] bg-[#070809] relative">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center mb-14">
          <span className="px-2.5 py-1 rounded-full text-[10px] font-berkeley uppercase tracking-wider bg-amber-500/10 text-amber-300 border border-amber-500/20 mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
          ...
          <div className="bg-[#0b0c0e] border border-white/[0.08] rounded-2xl p-6 relative overflow-hidden shadow-xl">
            <div className="flex items-center justify-between mb-4">
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-berkeley uppercase tracking-wider bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
            ...
            <div className="space-y-2 mt-4 text-xs font-berkeley text-zinc-400 border-t border-white/[0.06] pt-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-amber-300 font-semibold">Veo B-Roll Injected into Standoff</span>
              </div>
            </div>
          ...
          <div className="bg-[#0b0c0e] border border-amber-500/20 rounded-2xl p-6 relative overflow-hidden shadow-xl">
            <div className="flex items-center justify-between mb-4">
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-berkeley uppercase tracking-wider bg-amber-500/15 text-amber-300 border border-amber-500/30">
                <Zap className="w-3 h-3 text-amber-400" />
                NEURAL POLICY PEAK
              </span>
              <span className="font-berkeley text-xs text-amber-400/80">Phase 3 PPO</span>
            </div>

            <div className="flex items-baseline gap-2 mb-2">
              <span className="text-3xl sm:text-4xl font-bold font-berkeley text-amber-400">0.7301</span>
              <span className="text-xs font-berkeley text-amber-300/60">+8.48% Higher Metric</span>
            </div>

            <div className="space-y-2 mt-4 text-xs font-berkeley text-zinc-400 border-t border-white/[0.06] pt-4">
              <div className="flex justify-between">
                <span>Story Runtime:</span>
                <span className="text-amber-300 font-semibold">8.5 Seconds (204 frames @ 24fps)</span>
              </div>
              <div className="flex justify-between">
                <span>Narrative Integrity:</span>

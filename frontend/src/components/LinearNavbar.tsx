    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-b from-white/[0.12] to-white/[0.02] border border-white/[0.1] flex items-center justify-center shadow-inner group-hover:border-amber-500/50 transition-colors">
            <span className="font-berkeley font-bold text-xs tracking-tighter text-amber-400">
              NC
            </span>
          </div>

...
import { Database, Activity, Sparkles, Cpu } from "lucide-react";
...
export const LinearFeatures: React.FC = () => {
  ...
  return (
    <section id="architecture" className="py-20 md:py-28 border-t border-white/[0.06] relative font-inter">
      <div className="max-w-6xl mx-auto px-6">
        {/* Section Header */}
        <div className="flex flex-col items-center text-center mb-16">
          <span className="px-2.5 py-1 rounded-full text-xs font-medium uppercase tracking-wider bg-white/[0.04] text-zinc-400 border border-white/[0.08] mb-3">
            Core Architecture
          </span>
          <h2 className="font-bold text-3xl sm:text-4xl md:text-5xl tracking-tight text-white max-w-2xl">
          ...
          {features.map((feat) => {
            ...
            return (
              <div
                key={feat.num}
                id={feat.id}
                className="bg-[#0b0c0e] border border-white/[0.07] rounded-2xl p-6 flex flex-col justify-between group hover:border-white/[0.14] transition-colors shadow-lg"
              >
                <div>
                  ...
                  <h3 className="font-semibold text-lg text-white tracking-tight group-hover:text-indigo-300 transition-colors">
                    {feat.title}
                  </h3>
                ...
                <div className="mt-6 pt-4 border-t border-white/[0.05] flex items-center justify-between text-xs text-zinc-500 font-mono">

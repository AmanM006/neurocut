      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {features.map((feat) => {
            ...
            if (feat.accent === "amber") iconColor = "text-amber-400 bg-amber-500/10 border-amber-500/20";
            if (feat.accent === "emerald") iconColor = "text-emerald-400 bg-emerald-500/10 border-emerald-500/20";
            ...
            return (
              ...
              >
                <div>
                  ...
                  <h3 className="font-inter font-semibold text-lg text-white tracking-tight group-hover:text-amber-300 transition-colors">
                    {feat.title}
                  </h3>

...
export const TrainingProgress: React.FC = () => {
 ...
 <span className="flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[9px] font-mono bg-indigo-500/15 text-indigo-300 border border-indigo-500/30 animate-pulse">
 ...
 target="_blank"
 rel="noreferrer"
 className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-white/[0.04] hover:bg-white/[0.08] text-indigo-300 border border-indigo-500/30 hover:border-indigo-500/50 shadow-sm transition-all duration-150 font-mono active:scale-[0.98]"
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-600 text-black shadow-md shadow-indigo-500/20 border border-indigo-400/40 transition-all duration-150 active:scale-[0.98] font-mono disabled:opacity-50"
 >
 ...
 {showArchitectureInfo && (
 <div className="bg-[#0a0a0e] border border-indigo-500/30 rounded-xl p-3 mb-3 text-xs font-mono text-white/80 space-y-2 animate-fadeIn">
 ...
 <div className="bg-black/60 p-2.5 rounded-lg border border-indigo-500/20">
 ...
 <span className="px-2 py-0.5 rounded-full text-[9px] font-mono bg-indigo-500/15 text-indigo-300 border border-indigo-500/30">
 ...
 <div className="bg-[#08080a] rounded-lg p-2.5 border border-indigo-500/30 flex items-center justify-between">
 <div>
 <div className="flex items-center gap-1.5 text-[10px] text-indigo-400 font-semibold uppercase">
 ...
 <span className="text-[10px] text-indigo-300/80 font-normal">8.5s • 2 Scenes</span>
 </div>
 <p className="text-[10px] text-white/50 mt-0.5 leading-snug">
 <strong className="text-indigo-300">Goodhart's Law:</strong> Policy pruned setup scenes to maximize mean engagement (+8.5%).
 </p>
 </div>
 <span className="px-2 py-0.5 rounded text-[9px] font-bold bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 shrink-0 ml-2">
 PEAK SCALAR
 </span>
 </div>
 </div>
 ...
 <div className="bg-[#08080a] border border-white/[0.06] rounded-lg p-2.5 flex flex-col">
 <span className="text-[10px] uppercase font-mono text-white/40 flex items-center gap-1.5">
 <TrendingUp className="w-3 h-3 text-indigo-400" /> Rolling Avg (20)
 </span>

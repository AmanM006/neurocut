...
export default function StudioPage() {
 ...
 return (
 <LenisProvider>
 <div className="min-h-screen bg-[#08090a] text-zinc-100 selection:bg-indigo-500 selection:text-white flex flex-col">
 ...
 {/* Cloud Badge */}
 <span className="hidden lg:flex items-center px-2.5 py-1 rounded-xl text-[10px] font-berkeley bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-medium">
 ClickHouse Live
 </span>
 </div>
 </div>
 ...
 <span className="text-indigo-400">Cloud Active</span>
 </div>
 </div>
 ...
 <span className="absolute font-berkeley text-xs font-bold text-indigo-400">
 {gaugePercent}%
 </span>
 </div>
 </div>
